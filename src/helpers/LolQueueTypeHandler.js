const queues = [
    ...
    },
    {
        "queueId": 400,
        "map": "Summoner's Rift",
        "description": "5v5 Normal Draft Pick games",
        "notes": null
    },
    {
        "queueId": 410,
...
const findQueueType = (queueId) => {
    var queueType = 'undefined';
    
    queues.map((queue) => {
        (queue.queueId === queueId) ? (queueType = queue.description.split(' games')[0]) : (queueType = queueType)
        return null;
    });
